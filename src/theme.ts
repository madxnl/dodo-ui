...
function getLayoutCSS(theme: Theme) {
  ...
  addClasses('align-content', 'align', 'start,end,center,space-between,space-around,stretch')
  addClasses('align-items', 'align-items', 'start,end,center,stretch,baseline,safe-center')
...
function getTextCSS(theme: Theme) {
  ...
  addClass('center', 'text-align:center')
