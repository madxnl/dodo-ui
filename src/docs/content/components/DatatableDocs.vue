<template>
  <p>
    The <code>Datatable</code> component is a powerful table component that supports sorting, filtering, pagination, and
    more.
  </p>
  <DocsExample :example-src="exampleSrc" :context="context" />
</template>
