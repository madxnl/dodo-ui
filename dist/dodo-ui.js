...
var Ae = (d, t, e) => t in d ? Te(d, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : d[t] = e;
var ve = (d, t, e) => (Ae(d, typeof t != "symbol" ? t + "" : t, e), e);
import { defineComponent as z, openBlock as l, createBlock as V, TransitionGroup as Ee, withCtx as w, renderSlot as h, Transition as we, computed as B, createElementBlock as m, normalizeClass as f, normalizeStyle as J, Fragment as L, createTextVNode as F, toDisplayString as T, createCommentVNode as M, useAttrs as Ne, ref as _, mergeProps as oe, unref as u, createElementVNode as $, onMounted as ee, watchEffect as U, onBeforeUnmount as x, watch as Q, inject as se, provide as re, reactive as me, withModifiers as ne, createVNode as I, resolveDynamicComponent as le, renderList as K, Teleport as ke, nextTick as _e, onUnmounted as Fe, useSlots as ie, getCurrentInstance as De, withDirectives as fe, vShow as Le, vModelText as Re, createStaticVNode as de } from "vue";
...
const He = /* @__PURE__ */ z({
  ...
  setup(d) {
    const t = d, e = ["info", "warn", "success", "danger"], o = X(), n = B(() => {
      let s = t.text.trim();
  ...
  $style: Pe
}, Xl = /* @__PURE__ */ A(He, [["__cssModules", We]]), qe = ["disabled", "type"], Ue = /* @__PURE__ */ z({
  inheritAttrs: !1,
  __name: "Button",
  props: {
    color: {},
  ...
  setup(d) {
    const t = d, { colorPropRgb: e } = X(), o = B(() => {
      let s = "";
  ...
  $style: ot
}, G = /* @__PURE__ */ A(Ue, [["__cssModules", st]]), Yl = /* @__PURE__ */ z({
  __name: "Card",
  props: {
...
function Be() {
  const e = _(window.innerWidth), o = _(window.innerHeight), n = B(() => e.value < 600), r = B(() => e.value >= 600 && e.value < 1200), p = B(() => e.value >= 1200);
  function s() {
...
function X() {
  ...
  function e(v) {
    if (v instanceof Array)
      return v;
    const E = getComputedStyle(document.body).getPropertyValue(`--dodo-rgb-${v}`);
    return E ? E.split(",").map(Number) : [0, 0, 0];
  }
  function o(v) {
    return "#" + e(v).map((g) => g.toString(16).padStart(2, "0")).join("");
  }
  function n(v) {
...
function la(d) {
  ...
  async function s(i, c) {
    const k = t[i], v = k.name ?? y(i);
    if (k.required && !c)
      return `${v} is required`;
    if (k.isEmail && c != null && (typeof c != "string" || !c.includes("@")))
      return `${v} is not valid`;
    if (typeof c == "string") {
      if (k.minLen != null && c.length < k.minLen)
        return `${v} must be at least ${k.minLen} characters`;
      if (k.maxLen != null && c.length > k.maxLen)
        return `${v} must be less than ${k.maxLen} characters`;
    }
    if (k.validators)
      for (const E of k.validators) {
        const g = await E(c, v);
        if (g)
          return g;
      }
...
const it = ["onClick"], dt = ["checked"], ct = /* @__PURE__ */ z({
  ...
  $style: vt
}, $e = /* @__PURE__ */ A(ct, [["__cssModules", mt]]), ft = /* @__PURE__ */ z({
  __name: "Chip",
  props: {
    color: {}
  },
  ...
  $style: ht
}, aa = /* @__PURE__ */ A(ft, [["__cssModules", gt]]), bt = /* @__PURE__ */ z({
  __name: "Column",
  props: {
    gap: {},
    padding: {},
  ...
  $style: kt
}, W = /* @__PURE__ */ A(bt, [["__cssModules", _t]]), Ct = /* @__PURE__ */ $("h3", null, "Something went wrong", -1), he = `
...
`, ra = /* @__PURE__ */ z({
  __name: "CrashDialog",
  setup(d) {
    const t = at(), e = B(() => t.currentError.value), o = _(!1);
    return U(() => {
      o.value = !!e.value;
  ...
  style: { width: "0" },
  scope: "col"
}, Bt = ["onClick"], St = ["onClick"], Vt = { key: 0 }, It = /* @__PURE__ */ $("td", { colspan: "999" }, "No results", -1), zt = [
  It
], Tt = { colspan: "999" }, At = { key: 0 }, Et = /* @__PURE__ */ z({
  __name: "Datatable",
  props: {
    rows: {},
    columns: {},
  ...
  setup(d, { emit: t }) {
    ...
    }), s = B(() => e.columns.filter((a) => !a.disabled)), y = B(() => !!e.selection), i = B(() => {
      const a = s.value.find(k);
      return e.sortAsync || !a ? e.rows : e.rows.slice().sort((b, S) => {
        const R = j(a, b), P = j(a, S), pe = typeof R == "number" && typeof P == "number" ? P - R : `${P}`.localeCompare(`${R}`);
    ...
    function k(a) {
      var b;
      return ((b = o.value) == null ? void 0 : b.replace("-", "")) === a.sort;
    }
    function v(a) {
    ...
    async function H(a) {
      E(a) && (k(a) ? o.value = p.value ? void 0 : "-" + a.sort : o.value = a.sort, e.sortAsync && (r.value = !0, await e.sortAsync(o.value).finally(() => {
        r.value = !1;
      })));
    }
    function D(a) {
    ...
    function O(a) {
      const b = D(a);
      n.value.includes(b) ? n.value = n.value.filter((S) => S !== b) : n.value = n.value.concat(b);
    }
    function j(a, b) {
      return typeof a.value == "function" ? a.value(b) : typeof a.value == "string" ? b[a.value] : "";
    }
    function Y(a) {
      if (!y.value)
        return !1;
    ...
    const Z = B(() => y.value ? e.rows.filter((a) => n.value.includes(D(a))) : []);
    function C() {
      ...
      $("table", null, [
        $("tbody", null, [
          $("tr", {
            ...
            (l(!0), m(L, null, K(s.value, (S) => (l(), m("th", {
              key: S.name,
              scope: "col",
              class: f([E(S) ? a.$style.sortable : "", k(S) && a.$style.sortActive]),
              style: J([g(S), N(S)]),
              onClick: (R) => H(S)
            }, [
              $("span", {
          ...
          (l(!0), m(L, null, K(i.value, (S, R) => (l(), m("tr", {
            key: R,
            class: f([a.rowClick && a.$style.clickableRow, Y(S) && a.$style.rowSelected]),
            onClick: (P) => a.rowClick && a.rowClick(S)
          }, [
            y.value ? (l(), m("td", Vt, [
              I(u($e), {
                "model-value": Y(S),
                "onUpdate:modelValue": (P) => O(S)
              }, null, 8, ["model-value", "onUpdate:modelValue"])
            ])) : M("", !0),
            (l(!0), m(L, null, K(s.value, (P) => (l(), m("td", {
              key: P.name,
              class: f([]),
              style: J(g(P))
            }, [
          ...
          a.showFooter ? (l(), m("tr", {
            ...
            y.value ? (l(), m("td", At)) : M("", !0),
            (l(!0), m(L, null, K(s.value, (S) => (l(), m("th", {
              key: S.name,
              style: J(g(S)),
              scope: "col"
            }, [
              h(a.$slots, `${v(S)}-footer`, { column: S })
            ], 4))), 128))
          ], 2)) : M("", !0)
        ])
      ])
  ...
  $style: Gt
}, ia = /* @__PURE__ */ A(Et, [["__cssModules", Kt]]), Jt = /* @__PURE__ */ z({
  __name: "Dialog",
  props: {
    active: { type: Boolean }
  },
  ...
  $style: Xt
}, xt = /* @__PURE__ */ A(Jt, [["__cssModules", Yt]]), eo = /* @__PURE__ */ z({
  __name: "Dropdown",
  props: {
    modelValue: { type: Boolean },
    padding: {},
  ...
  setup(d, { emit: t }) {
    ...
    Q(
      () => e.modelValue,
      () => {
        console.log("watch modelValue", e.modelValue), s(!!e.modelValue);
      },
      { immediate: !0 }
    ), x(() => {
      console.log("onBeforeUnmount"), s(!1);
    });
    function s(g) {
      o.value !== g && (console.log("toggle", g), !(e.disabled && g) && (o.value = g, t("update:modelValue", g), g ? _e().then(() => {
        E(), window.addEventListener("click", k, { passive: !0, capture: !0 }), window.addEventListener("scroll", v, { passive: !0, capture: !0 }), window.addEventListener("resize", v);
      }) : (window.removeEventListener("click", k, { capture: !0 }), window.removeEventListener("scroll", v, { capture: !0 }), window.removeEventListener("resize", v))));
    }
    function y(g) {
      e.trigger !== "hover" && (console.log("onClick", g.target, o.value), s(!o.value), g.preventDefault());
    }
    function i() {
      e.trigger === "hover" && (console.log("onMouseOver hover"), s(!0));
    }
    function c(g) {
      var O, j;
      if (!o.value || e.trigger !== "hover")
        return;
      console.log("onMouseLeave", g.target);
      const N = g.relatedTarget, H = (O = p.value) == null ? void 0 : O.contains(N), D = (j = r.value) == null ? void 0 : j.contains(N);
      H || D || s(!1);
    }
    function k(g) {
      var N, H;
      if (console.log("onWindowClick", g.target), g.target) {
        const D = (N = p.value) == null ? void 0 : N.contains(g.target), O = (H = r.value) == null ? void 0 : H.contains(g.target);
        if (console.log("clickOnTrigger", { clickOnTrigger: D, clickOnDropdown: O }), D || O)
          return;
      }
      s(!1);
    }
    ...
    function E() {
      ...
      if (!N)
        return;
      const H = N.scrollWidth, D = p.value.getBoundingClientRect(), O = window.innerWidth, j = window.innerHeight, Y = D.bottom + 300 + 16 > j, Z = Math.max(16, Math.min(D.left, O - H - 16)), C = Math.min(600, O - 16 * 2);
      let a = `left: ${Z}px; max-width:${C}px;`;
      Y ? a += `bottom: ${j - D.top}px; max-height: ${D.top - 16}px;` : a += `top: ${D.bottom}px; max-height: ${j - D.bottom - 16}px;`, n.value = a, o.value && requestAnimationFrame(E);
    }
    return re(Me, { toggle: s }), (g, N) => (l(), m(L, null, [
      $("div", oe({
        ref_key: "el",
        ref: p,
        class: [g.$style.trigger, g.disabled && g.$style.disabled]
      }, g.$attrs, {
        onClick: y,
        onMouseover: i,
        onMouseleave: c
      }), [
        h(g.$slots, "default", { isActive: o.value })
      ], 16),
      o.value ? (l(), m("div", {
        key: 0,
        class: f([g.$style.container, "dodo-fonts"]),
        style: J(n.value)
      }, [
        $("div", {
          ref_key: "content",
          ref: r,
          class: f(g.$style.content),
          onMouseleave: c
        }, [
          I(u(W), {
            padding: g.padding ?? "2",
  ...
  $style: lo
}, ce = /* @__PURE__ */ A(eo, [["__cssModules", ao]]), ro = {
  key: 0,
  ...
  $style: fo
}, $o = /* @__PURE__ */ A(io, [["__cssModules", yo]]), ho = /* @__PURE__ */ z({
  __name: "Field",
  props: {
    disabled: { type: Boolean },
    button: { type: Boolean }
  ...
  $style: _o
}, Ie = /* @__PURE__ */ A(ho, [["__cssModules", Co]]), Mo = /* @__PURE__ */ z({
  __name: "FluidGrid",
  props: {
    columnSize: {},
    gap: {},
  ...
  setup(d) {
    ...
    const s = B(() => t.columnSize >= n.value), y = B(() => {
...
}), Bo = "dodo-fluidgrid", So = "dodo-fluidgrid-onecolumn", Vo = {
  FluidGrid: Bo,
  oneColumn: So
}, Io = {
  $style: Vo
}, da = /* @__PURE__ */ A(Mo, [["__cssModules", Io]]), zo = /* @__PURE__ */ z({
  __name: "Grid",
  props: {
    columnSize: {},
    gap: {},
...
}), To = "dodo-grid-component", Ao = "dodo-grid-autofill", Eo = {
  component: To,
  autoFill: Ao,
  ...
  $style: Eo
}, ca = /* @__PURE__ */ A(zo, [["__cssModules", No]]), ae = "Outlined", ge = "300", Fo = /* @__PURE__ */ z({
  __name: "Icon",
  props: {
    name: {},
    color: {},
  ...
  $style: Po
}, q = /* @__PURE__ */ A(Fo, [["__cssModules", Wo]]), qo = ["id", "value", "placeholder", "disabled", "maxlength", "type", "name", "autofocus"], ua = /* @__PURE__ */ z({
  __name: "Input",
  props: {
    modelValue: {},
    id: {},
...
const Zo = /* @__PURE__ */ z({
  ...
  setup(d) {
    ...
    const r = se(Ce), p = B(() => r == null ? void 0 : r.collapsed.value), s = B(() => r == null ? void 0 : r.renderMobile.value), y = B(() => s.value || !p.value);
    async function i(c) {
  ...
  $style: ss
}, be = /* @__PURE__ */ A(Zo, [["__cssModules", ns]]), ls = ["onClick"], as = { style: { "margin-right": "8px" } }, rs = /* @__PURE__ */ z({
  __name: "NavBar",
  props: {
    mobile: { type: Boolean }
  },
  setup(d) {
    const t = d, { screenLarge: e } = Be(), o = nt("NavBar-collapse", null), n = _(!1), r = B(() => t.mobile || !e.value);
    ...
    return (s, y) => (l(), m("div", {
      ...
      $("div", {
        ...
        r.value ? (l(), m("div", {
          ...
          h(s.$slots, "default", { inMobileBar: !0 }),
          h(s.$slots, "navbar-footer", { inMobileBar: !0 }),
          I(be, {
            text: "Menu",
            icon: "menu",
  ...
  $style: bs
}, va = /* @__PURE__ */ A(rs, [["__cssModules", ws]]), ks = ["onClick"], ze = rt(() => {
  ...
  }, r = B(() => t == null ? void 0 : t.headerText.value), p = () => {
    !e || !t || (t.expandedMenu.value.includes(e.uid) ? t.expandedMenu.value = [] : t.expandedMenu.value = o(e));
  }, s = B(() => !e || !t ? !1 : t.activeItems.value.includes(e.uid)), y = B(() => !e || !t ? !1 : t.expandedMenu.value.length ? t.expandedMenu.value.includes(e.uid) : t.activeItems.value.includes(e.uid));
  ...
  __name: "NavBarNew",
  setup(d) {
    const { headerText: t, mobileToggle: e } = ze.createAndProvide(), { screenLarge: o } = Be(), n = B(() => !o.value);
    function r() {
      e.value = !1;
    }
    return (p, s) => (l(), m("div", {
...
}), Ms = "dodo-navbarnew-root", Bs = "dodo-navbarnew-navbar", Ss = "dodo-navbarnew-middle", Vs = "dodo-navbarnew-footer", Is = "dodo-navbarnew-wrapmobile", zs = "dodo-navbarnew-main", Ts = "dodo-navbarnew-backdrop", As = "dodo-navbarnew-menubutton", Es = "dodo-navbarnew-mobilemenu", Ns = "dodo-navbarnew-mobiletoggle", Fs = "dodo-navbarnew-mobilenav", Ds = {
  root: Ms,
  NavBar: Bs,
  middle: Ss,
  footer: Vs,
  ...
  $style: Ds
}, ma = /* @__PURE__ */ A(Cs, [["__cssModules", Ls]]), Rs = ["href"], Hs = { key: 0 }, Os = /* @__PURE__ */ z({
  __name: "NavItem",
  props: {
    link: {},
    text: {},
  ...
  setup(d) {
    const t = d, e = B(() => t.link ? u(t.link.isActive) : !1), o = B(() => t.text), { isExpanded: n, showAsActive: r, toggleExpand: p } = _s({ text: o, active: e }), s = ie();
    async function y(i) {
        ...
        default: w(() => {
          ...
          return [
            $("a", {
              ...
              href: u((k = i.link) == null ? void 0 : k.href),
              onClick: y
            }, [
              $("div", {
...
}), js = "dodo-navitem-el", Ps = "dodo-navitem-link", Ws = "dodo-navitem-submenu", qs = "dodo-navitem-expanded", Us = "dodo-navitem-active", Gs = "dodo-navitem-important", Ks = "dodo-navitem-textwrap", Js = "dodo-navitem-icon", Zs = "dodo-navitem-text", Qs = "dodo-navitem-secondary", Xs = {
  el: js,
  link: Ps,
  submenu: Ws,
  expanded: qs,
  ...
  $style: Xs
}, fa = /* @__PURE__ */ A(Os, [["__cssModules", Ys]]), xs = /* @__PURE__ */ z({
  __name: "Row",
  props: {
    gap: {},
    padding: {},
  ...
  $style: tn
}, te = /* @__PURE__ */ A(xs, [["__cssModules", on]]), sn = /* @__PURE__ */ z({
  ...
  emits: ["update:modelValue"],
  setup(d, { emit: t }) {
    const e = d, o = B(() => (e.multiple ? [e.modelValue].flat() : [e.modelValue]).filter(H)), n = _(!1), r = _(""), p = _(), s = _(), y = _(), i = _();
    U(() => {
      ...
      n.value && setTimeout(() => {
        var b;
        const C = (b = y.value) == null ? void 0 : b.$el, a = C == null ? void 0 : C.querySelector("[data-selectactive]");
        a == null || a.scrollIntoView({ block: "center" });
      }, 0);
    });
    const c = _(!1), k = B(() => e.options.length > pn), v = B(() => k.value && !c.value ? 6 : e.options.length), E = B(() => r.value || e.options.length >= 10), g = B(() => {
      const C = r.value.toLowerCase(), a = e.options.filter((R) => `${R.value}|${R.label}`.toLowerCase().includes(C));
      if (!e.multiple)
        return a;
      const b = a.filter((R) => o.value.find((P) => O(R, P))), S = a.filter((R) => !b.includes(R));
      return b.concat(S);
    }), N = B(() => e.placeholder ? e.placeholder : e.multiple ? "Select one or more" : "Select one");
    function H(C) {
      return e.options.find((a) => O(a, C));
    }
    function D(C) {
      let a = C.value;
      e.multiple && (o.value.includes(a) ? a = o.value.filter((b) => !O(C, b)) : a = o.value.concat(C.value)), t("update:modelValue", a);
    }
    function O(C, a) {
      return C.value === a;
    }
    ...
    function Y(C) {
      return o.value.some((a) => O(C, a));
    }
    function Z(C) {
      var S, R;
      const a = (S = i.value) == null ? void 0 : S.$el.contains(C.target), b = (R = y.value) == null ? void 0 : R.$el.contains(C.target);
      n.value = a || b;
    }
    return ee(() => {
      ...
      $("div", null, T({ dropdownActive: n.value }), 1),
      C.variant === "buttons" ? (l(), V(u(te), {
        key: 0,
        gap: "1",
        wrap: ""
      }, {
        default: w(() => [
          (l(!0), m(L, null, K(C.options.slice(0, v.value), (b, S) => (l(), V(u(G), {
            key: j(b),
            color: Y(b) ? "info" : void 0,
            active: Y(b),
            variant: Y(b) && !C.multiple ? "solid" : void 0,
            disabled: C.disabled,
            small: C.size === "s",
            rounded: "",
            onClick: (R) => D(b)
          ...
          k.value ? (l(), m(L, { key: 0 }, [
            c.value ? (l(), V(u(G), {
              ...
              variant: "text",
              rounded: "",
              onClick: a[0] || (a[0] = (b) => c.value = !c.value)
            }, {
              default: w(() => [
                F(" Less "),
                I(u(q), {
              ...
              variant: "text",
              rounded: "",
              onClick: a[1] || (a[1] = (b) => c.value = !c.value)
            }, {
              default: w(() => [
        ...
        key: 1,
        modelValue: n.value,
        "onUpdate:modelValue": a[5] || (a[5] = (b) => n.value = b),
        disabled: C.disabled
      }, {
        dropdown: w(() => [
          I(u(W), {
            ...
            default: w(() => [
              fe(I(u(te), {
                ...
                default: w(() => [
                  I(u(Hl), {
                    ...
                    ref: s,
                    modelValue: r.value,
                    "onUpdate:modelValue": a[3] || (a[3] = (b) => r.value = b),
                    type: "search",
                    placeholder: "Search",
                    tabindex: "0",
                    style: { "flex-grow": "1" }
              ...
              I(u(rn), null, {
                default: w(() => [
                  (l(!0), m(L, null, K(g.value, (b, S) => (l(), V(u($o), {
                    key: `${b.value}`,
        ...
        default: w(() => [
          I(u(Ie), {
            ...
            after: w(() => [
              I(u(q), { name: "arrow_drop_down" })
            ]),
            default: w(() => [
              o.value.length ? (l(), m("p", dn, [
                (l(!0), m(L, null, K(o.value, (b, S) => (l(), m(L, null, [
                  S ? (l(), m(L, { key: 0 }, [
                    F(", ")
                  ], 64)) : M("", !0),
                  H(b) ? h(C.$slots, "default", {
                    key: 1,
                    index: C.options.indexOf(H(b)),
                    option: H(b)
                  }, () => [
                    F(T(j(H(b))), 1)
                  ]) : (l(), m(L, { key: 2 }, [
  ...
  $style: fn
}, ya = /* @__PURE__ */ A(vn, [["__cssModules", yn]]), $n = /* @__PURE__ */ z({
  ...
  emits: ["update:modelValue"],
  setup(d, { emit: t }) {
    const e = d, o = B(() => e.multiple ? [e.modelValue].flat() : [e.modelValue]);
    function n(s, y) {
      return s.value === y;
    }
    function r(s) {
    ...
    return (s, y) => (l(), m("div", {
      ...
      (l(!0), m(L, null, K(s.options, (i, c) => (l(), V(u(G), oe({
        key: i.label
  ...
  $style: bn
}, $a = /* @__PURE__ */ A($n, [["__cssModules", wn]]), kn = {
  key: 0,
  viewBox: "0 0 48 48"
  ...
  key: 3,
  viewBox: "2 2 46 46"
}, An = /* @__PURE__ */ $("path", { d: "M25,3C12.85,3,3,12.85,3,25c0,11.03,8.125,20.137,18.712,21.728V30.831h-5.443v-5.783h5.443v-3.848 c0-6.371,3.104-9.168,8.399-9.168c2.536,0,3.877,0.188,4.512,0.274v5.048h-3.612c-2.248,0-3.033,2.131-3.033,4.533v3.161h6.588 l-0.894,5.783h-5.694v15.944C38.716,45.318,47,36.137,47,25C47,12.85,37.15,3,25,3z" }, null, -1), En = [
  An
], Nn = {
  key: 4,
  ...
  key: 5,
  viewBox: "0 0 24 24"
}, Hn = /* @__PURE__ */ $("path", { d: "M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" }, null, -1), On = [
  Hn
], jn = {
  key: 6,
  viewBox: "6 6 36 36"
  ...
  setup(d) {
    return (t, e) => (l(), m("span", {
      ...
      t.name === "google" ? (l(), m("svg", kn, Cn)) : t.name === "twitter" ? (l(), m("svg", Mn, Sn)) : t.name === "slack" ? (l(), m("svg", Vn, zn)) : t.white && t.name === "facebook" ? (l(), m("svg", Tn, En)) : t.name === "facebook" ? (l(), m("svg", Nn, Ln)) : t.white && t.name === "linkedin" ? (l(), m("svg", Rn, On)) : t.name === "linkedin" ? (l(), m("svg", jn, qn)) : t.name === "whatsapp" ? (l(), m("svg", Un, Kn)) : M("", !0)
    ], 2));
  }
  ...
  $style: xn
}, ha = /* @__PURE__ */ A(Jn, [["__cssModules", el]]), tl = /* @__PURE__ */ $("path", {
  stroke: "currentColor",
  fill: "none",
  ...
  $style: il
}, cl = /* @__PURE__ */ A(nl, [["__cssModules", dl]]), ul = { key: 1 }, pl = { key: 0 }, vl = {
  key: 1,
  class: "dodo-fade-secondary"
}, ml = {
  key: 0,
  class: "dodo-fade-secondary"
}, fl = /* @__PURE__ */ $("br", null, null, -1), yl = /* @__PURE__ */ z({
  __name: "Stepper",
  props: {
    stepIndex: {},
    steps: {},
  ...
  setup(d, { emit: t }) {
    const e = d, o = _(0), n = B(() => e.steps[o.value]);
    function r() {
      o.value--;
    }
    async function p() {
    ...
    return U(() => {
      ...
      default: w(() => [
        (l(!0), m(L, null, K(s.steps, (i, c) => (l(), V(u(te), {
          key: i.key,
          align: "stretch",
          gap: "4",
  ...
  $style: wl
}, ga = /* @__PURE__ */ A(yl, [["__cssModules", kl]]), _l = ["onClick"], Cl = ["onClick"], Ml = /* @__PURE__ */ $("hr", null, null, -1), Bl = /* @__PURE__ */ z({
  __name: "Tabs",
  props: {
    tabs: {},
    tabIndex: {}
  ...
  setup(d, { emit: t }) {
    const e = d, o = _(), n = _(""), r = B(() => e.tabs.find((v) => k(v) === n.value)), p = _(99), s = B(() => e.tabs.slice(0, p.value)), y = B(() => e.tabs.slice(p.value)), i = _();
    U(() => {
      !r.value && e.tabs.length && (n.value = k(e.tabs[0]));
    }), ee(() => {
    ...
    function c() {
      var N;
      const E = ((N = o.value) == null ? void 0 : N.clientWidth) || 1e3, g = Math.max(1, Math.floor(E / 60));
      p.value = g;
    }
    Q(
      () => e.tabIndex,
      () => {
        e.tabIndex != null && e.tabs[e.tabIndex] && (n.value = k(e.tabs[e.tabIndex]));
      },
      { immediate: !0 }
    ), Q(
      () => r.value,
    ...
    return (v, E) => (l(), V(u(W), {
      ...
      default: w(() => [
          ...
          default: w(() => [
            $("div", {
              ...
              $("div", {
                ...
                (l(!0), m(L, null, K(s.value, (g, N) => (l(), m("div", {
                  key: k(g),
                  class: f([v.$style.tab, n.value === k(g) && v.$style.active, g.disabled && v.$style.disabled]),
                  onClick: (H) => n.value = k(g)
                }, [
                  $("h5", {
              ...
              I(u(ce), null, {
                ...
                dropdown: w(() => [
                  (l(!0), m(L, null, K(y.value, (g, N) => (l(), m("p", {
                    key: k(g),
                    onClick: (H) => n.value = k(g)
                  }, [
                    h(v.$slots, "tab-title", {
        ...
        r.value ? h(v.$slots, r.value.slot ?? "default", {
          key: 0,
          tab: r.value
        }) : M("", !0)
      ]),
...
}), Sl = "dodo-tabs-bar", Vl = "dodo-tabs", Il = "dodo-tabs-tab", zl = "dodo-tabs-tabname", Tl = "dodo-tabs-active", Al = "dodo-tabs-disabled", El = {
  bar: Sl,
  tabs: Vl,
  tab: Il,
  tabName: zl,
  ...
  $style: El
}, ba = /* @__PURE__ */ A(Bl, [["__cssModules", Nl]]), Fl = /* @__PURE__ */ z({
  __name: "TextInput",
  props: {
    id: {},
    modelValue: {},
  ...
  $style: Ll
}, Hl = /* @__PURE__ */ A(Fl, [["__cssModules", Rl]]), Ol = /* @__PURE__ */ z({
  __name: "Tooltip",
  props: {
    text: {},
    disabled: { type: Boolean },
  ...
  setup(d) {
    const t = d, e = _(!1), o = _(""), n = _(), r = _(), p = ie(), s = B(() => t.disabled || !(t.text || p["tooltip-text"]));
    x(i);
    async function y() {
      if (e.value || s.value)
        return;
      e.value = !0, await _e();
      const c = n.value.getBoundingClientRect(), k = r.value.getBoundingClientRect();
      t.side, c.bottom + k.height < window.innerHeight;
      let v = (c.right + c.left - k.width) / 2, E = c.bottom;
      t.side === "right" ? (v = c.right, E = (c.bottom + c.top - k.height) / 2) : t.side === "top" ? (v = (c.left + c.right - k.width) / 2, E = c.top - k.height) : t.side === "left" && (v = c.left - k.width, E = (c.bottom + c.top - k.height) / 2), E = Math.round(Math.max(Math.min(E, window.innerHeight - k.height), 0)), v = Math.round(Math.max(Math.min(v, window.innerWidth - k.width), 0)), o.value = `left:${v}px;top:${E}px`;
    }
    function i() {
      e.value = !1;
    }
...
}), jl = "dodo-tooltip", Pl = "dodo-tooltip-content", Wl = "dodo-tooltip-text", ql = "dodo-tooltip-trigger", Ul = {
  Tooltip: jl,
  content: Pl,
  text: Wl,
  trigger: ql
  ...
  $style: Ul
}, ue = /* @__PURE__ */ A(Ol, [["__cssModules", Gl]]);
export {
  Ql as Animated,
  Xl as Avatar,
  G as Button,
